...
let invokeResultID = ''
let queryResultID = ''
let identityResultID = ''
const deleteIdentityResultID = ''
let currentBlockResultID = ''
let blockResultID = ''
let transactionResultID = ''
const xooaClient = XooaClient()
 ...
 * */
	let [ error, pendingResponse, data ] = await xooaClient.invoke('set', {}, { args: [ 'abc', '123' ] })
	console.log(data)
	trxnId = data.txId;
 ...
 * */
	...
	console.debug(error, pendingResponse, data)
