...
(function (root, factory) {
  if (typeof module === "object" && module.exports)
    ...
    if (!root.XooaJavascriptSdk) root.XooaJavascriptSdk = {};
  ...
  exports.prototype.setLoggerLevel = function (level) {
    if (level === undefined || level === null)
      throw new Error(
        "Missing the required parameter 'level' when calling setLoggerLevel"
      );
  ...
  exports.prototype.normalizeContent = function (content) {
    ...
    for (let i = 0; i < content.length; i++) {
      const arg = content[i];
      finalContent +=
        finalContent === "" ? JSON.stringify(arg) : "::" + JSON.stringify(arg);
    }
    return finalContent;
  };
  ...
  exports.prototype.setApiToken = function (token) {
    if (token === undefined || token === null)
      throw new Error(
        "Missing the required parameter 'token' when calling result"
      );
  ...
  exports.prototype.setURL = function (url) {
    if (url === undefined || url === null)
      throw new Error(
        "Missing the required parameter 'url' when calling result"
      );
  ...
  exports.prototype.jsonPreferredMime = function (contentTypes) {
    for (let i = 0; i < contentTypes.length; i++)
      if (this.isJsonMime(contentTypes[i])) return contentTypes[i];
   ...
   */
  exports.prototype.callApi = async function callApi(
    path,
    httpMethod,
    pathParams,
    queryParams,
